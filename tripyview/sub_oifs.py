...
def accumulated_to_instantaneous(data_set, vname):
    ...
    vname: Has to be in the list of known accumulated fields for this function to have an effect. 
           ...
           Currently supported: 'tisr', 'ttr', 'ttrc', 'tsr', 'tsrc', 'ssr', 'ssrc', 'ssrd', 'str', 'strc', 'strd', 'cp', 'lsp', 'tp', 'e', 'ro', 'sf', 'slhf', 'sshf'
    ...
    accumulated_fields = ['tisr', 'ttr', 'ttrc', 'tsr', 'tsrc', 'ssr', 'ssrc', 'ssrd', 'str', 'strc', 'strd', 'cp', 'lsp', 'tp', 'e', 'ro', 'sf', 'slhf', 'sshf']
